    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <h1 class="latest text-center mb-5 text-white">Auction</h1>
                            ...
                            <div class="card bg-dark text-white">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(route('item.show', ['item' => $item->id])); ?>"
                                       class="w-100 btn btn-outline-light">Bid
                                        Now</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Cricket 24\Online-Auction-System--php-laravel-master\Online-Auction-System--php-laravel-master\resources\views/home.blade.php ENDPATH**/ ?>